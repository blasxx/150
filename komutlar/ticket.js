    ...
    client.channels.cache
      ...
      .send(
        new Discord.MessageEmbed()
          .setTitle(`**Cold Developement / Staff Apply**`)
          .setFooter(`Cold Turkey`, client.user.avatarURL())
          .setColor(`#ee7621`)
          .setDescription(
            `**▸ :flag_tr: Staff Alım Talebi açarken lütfen Doğru ve Düzgün bir şekilde açınız, aksi taktirde açılan destek taleblerine Cevap verilmeyecektir ve kapatılcaktır.
                
            ▸ Staff Alım Talebi açmak için aşağıdaki Emojiye Basmanız Yeterli Olucaktır, ardından size Özel Kanal açılır ve sizinle özel olarak ilgileniriz.
                 **
                        ▸ 
           **  :flag_eu:  When opening a Staff Recruitment Request, please open it correctly and properly, otherwise the opened support requests will not be answered and will be closed.
                
            ▸ To open a Staff Recruitment Request, it will be enough to press the following Emoji, then a Special Channel will be opened for you and we will take care of you specially.**
