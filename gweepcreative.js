...
client.on("guildMemberAdd", member => {
  const hosgeldin = new Discord.MessageEmbed()
    .setThumbnail(
      "https://cdn.discordapp.com/attachments/1056987967631151114/1058862823595331746/123245645-removebg-preview.png"
    )
     .setAuthor(`Merhaba Sende Aramıza Hoşgeldin`)
    .setDescription("Seni aramız da görmekten onur ve şeref duyuyoruz.")
   .setColor("#00ff00")
    .addField("**Botumuzu sunucunuza Eklemeyi Unutmayın **")
   .addField(
      "**Sunucumuz**",
      "[Davet](https://discord.gg/BEbfUBbnUa)"
)
.addField(
      "**Botu Eklemek İçin**",
      "[Link](https://discord.com/oauth2/authorize?client_id=1054835037650038884&scope=bot&permissions=8)"
)
...
client.on('ready', () => {
  client.channels.cache.get('1046363774103326751').join();
})
